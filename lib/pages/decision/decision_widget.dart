...
class DecisionWidget extends StatefulWidget {
  const DecisionWidget({super.key});

  static String routeName = 'Decision';
  static String routePath = 'decision';
...
class _DecisionWidgetState extends State<DecisionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DecisionModel());
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF1A0547),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
